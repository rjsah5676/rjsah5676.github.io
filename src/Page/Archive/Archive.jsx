          ...
          <div className='archive-container'>
              ...
              <Slider {...settings}>
                ...
                <ArchiveBox date={'2024-12-18'} text={(<p>반응속도 테스트 게임의 버그가 좀 있어서 고쳐야한다.<br/>
                    ...
                    고치긴 했는데 State를 고치는 방식으로 하고싶었지만 일단 reload하는 방식으로 하였다.<br/>
                    제출 방식도 고치고 중복제출도 수정하였다.<br/></p>)}/>
                <ArchiveBox date={'2024-12-24'} text={(<p>내일은 크리스마스~<br/>
                    요즘들어 홈페이지 개발 할 시간이 많이 줄었지만..<br/>
                    언젠간 다시 업데이트를 하겠지?🥹
                    </p>)}/>
                <ArchiveBox date={'2025-01-17'} text={(<p>싹다 갈아엎었다.<br/>
                최근 프론트엔드 연습으로 또 홈페이지를 만들었었다.<br/>
                근데 결과물이 나름 만족스러워서 이 홈페이지에 적용해봤다.<br/>
                여기 페이지랑 멜론게임 페이지만 손좀 봐야겠다.
                </p>)}/>
                <ArchiveBox date={'2025-05-08'} text={(<p>끝났다..<br/>
                5주간의 여정이 한 번의 발표로 끝나니까 뭔가.. 묘하네<br/>
                고생했다 나!<br/>
                앞으로도 힘내서 해보자
                </p>)}/>
              </Slider>
