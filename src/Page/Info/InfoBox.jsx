  ...
  if (idx === 1)
    return (
      <div className="info-item">
        <Link
          to={{ pathname: "infoPage", state: { idx: idx } }}
          ...
          <div>
            ...
            <div className="info-link-test">
              <a
                ...
                style={
                  linkIndex === idx
                    ? { backgroundImage: `url(${gitHoverImg})` }
              ...
              <a
                href="https://softcon.ajou.ac.kr/works/works_prev.asp?uid=421&wTerm=2021-1"
                onMouseOver={() => setLinkIndex2(idx)}
                onMouseOut={() => setLinkIndex2(0)}
                style={
                  linkIndex2 === idx
                    ? { backgroundImage: `url(${pageOutHoverImg})` }
                    : { backgroundImage: `url(${pageOutImg})` }
                }
                className="info-link"
              >
                {" "}
        ...
        <div className="right-content">
          <div>
            ...
            <div className="info-link-test">
              ...
              <a
                href="https://rjsah5676.github.io/"
                onMouseOver={() => setLinkIndex2(idx)}
                onMouseOut={() => setLinkIndex2(0)}
                style={
                  linkIndex2 === idx
      ...
      <div className="info-item">
        ...
        <div className="right-content">
          ...
          <div className="info-link-test">
            ...
            <a
              href="https://solved.ac/profile/rjsah5676"
              onMouseOver={() => setLinkIndex2(idx)}
              onMouseOut={() => setLinkIndex2(0)}
              style={
                linkIndex2 === idx
