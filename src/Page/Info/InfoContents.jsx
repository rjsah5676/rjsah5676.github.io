  ...
  if (idx === 1)
    return (
      <div className="info-contents">
        ...
        <InfoContentsDetail
          title={"1. 개요"}
          text={`AirBoard는 웹캠을 이용해 필기와 제스처 기능을 지원하는 화상 회의 플랫폼이다.
  ...
  if (idx === 3)
    return (
      <div className="info-contents">
        ...
        <InfoContentsDetail
          title={"1. 개요"}
          text={`요리조리는 음식 레시피를 공유할 수 있는 커뮤니티 사이트이다.
  ...
  if (idx === 10)
    return (
      <div className="info-contents">
        ...
        <div className="info-contents-period">
          {cImg} 2025.03.31 - 2025.05.08
        </div>
        <div className="info-contents-tech">
          <div className="tech-box">React</div>
          <div className="tech-box">SpringBoot</div>
